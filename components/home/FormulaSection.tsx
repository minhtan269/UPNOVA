    ...
    return (
        <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6 relative z-10 text-center">
                <h2 className="text-3xl font-extrabold mb-4">Carbon Formula</h2>
                <p className="text-gray-400 mb-10 max-w-2xl mx-auto">
                    ACRM uses V2 model-specific energy as default. V1 is retained as a class-based fallback
                    derived from the same J/token scale for consistency.
                </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mx-auto max-w-5xl text-left">
                    <div className="rounded-2xl bg-white/5 border border-white/10 p-8 backdrop-blur-md hover:bg-white/[0.08] transition-colors">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-[#0FA697]">V1 - Class Fallback</h3>
                        </div>
                    ...
                    <div className="rounded-2xl bg-white/5 border border-[#AED911]/20 p-8 backdrop-blur-md hover:bg-white/[0.08] transition-colors relative">
                        ...
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xl">🎯</span>
                            <h3 className="text-lg font-bold text-[#AED911]">V2 - Model Specific</h3>
                        </div>
                ...
                <div className="mt-10 mx-auto max-w-5xl rounded-2xl bg-white/5 border border-white/10 p-6 backdrop-blur-md">
                    <h3 className="font-bold text-[#D9CD2B] mb-4 text-lg text-center">🌍 Carbon Intensity (gCO2/kWh)</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        {[
                            { label: "Global Avg", value: CARBON_INTENSITY, flag: "🌐" },
                            { label: "Vietnam", value: CARBON_INTENSITY_BY_REGION.vietnam, flag: "🇻🇳" },
                            { label: "EU", value: CARBON_INTENSITY_BY_REGION.eu, flag: "🇪🇺" },
                            { label: "Nordics", value: CARBON_INTENSITY_BY_REGION.nordics, flag: "🇸🇪" },
                        ].map((region) => (
